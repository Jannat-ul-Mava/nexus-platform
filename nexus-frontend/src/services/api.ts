...
export const paymentAPI = {
  ...
  withdraw:       (amount: number)             => api.post('/payments/withdrawal', { amount, type: 'withdrawal' }),
...
export const collaborationAPI = {
  send:    (entrepreneurId: string, message: string) => api.post('/collaborations', { entrepreneurId, message }),
...
export const messageAPI = {
  ...
  getMessages:      (userId: string, page?: number) => api.get(`/messages/${userId}`, { params: { page } }),
...
export const notificationAPI = {
  ...
  markAsRead: (notificationIds?: string[]) => api.patch('/notifications/read', { notificationIds }),
